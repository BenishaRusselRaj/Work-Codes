...
#%%
with open("D:\\New folder (2)\\PHY\\PHY_6.1_25Deg_AllCycles_AllCycles_raw.pkl",'rb') as f:
    data = pickle.load(f)
    data['New_Cycle_No']=data['New_Cycle_No'].astype(object)
    data=data[data.New_Cycle_No<=1092]
    print('1/4............')
    ...
    df = np.array_split(data, 3)
    df[0].to_pickle('PHY_6.1_25Deg_AllCycles_1092Cycles_processed_1.pkl')
    df[1].to_pickle('PHY_6.1_25Deg_AllCycles_1092Cycles_processed_2.pkl')
    df[2].to_pickle('PHY_6.1_25Deg_AllCycles_1147Cycles_processed_3.pkl')
#    df[3].to_pickle('PHY_4.1_25Deg_AllCycles_1147Cycles_processed_4.pkl')
#    df[4].to_pickle('PHY_4.1_25Deg_AllCycles_1147Cycles_processed_5.pkl')
    end=time.time()
    print(end-start)
