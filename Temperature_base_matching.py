...
files = glob.glob("C:\\Users\\IITM\\Desktop\\AMBEDKAR\\PHY15\\cccv1\\datalogger\\*.csv") # path to the Folder in which the data logger files are stored
cols=['Record_No','Realtime','T_Ch1','Alarm_Ch1','T_Ch2','Alarm_Ch2','T_Ch3','Alarm_Ch3','T_Ch4','Alarm_Ch4','T_Ch5','Alarm_Ch5','T_Ch6','Alarm_Ch6','T_Ch7','Alarm_Ch7','T_Ch8','Alarm_Ch8','T_Ch9','Alarm_Ch9','T_Ch10','Alarm_Ch10','T_Ch11','Alarm_Ch11','T_Ch12','Alarm_Ch12','T_Ch13','Alarm_Ch13','T_Ch14','Alarm_Ch14','T_Ch15','Alarm_Ch15','T_Ch16','Alarm_Ch16','T_Ch17','Alarm_Ch17','T_Ch19','Alarm_Ch19'] # assigns Column names
#cols=['Record_No','Realtime','','T_Ch1','Alarm_Ch1','T_Ch2','Alarm_Ch2','T_Ch3','Alarm_Ch3','T_Ch4','Alarm_Ch4','T_Ch5','Alarm_Ch5','T_Ch6','Alarm_Ch6','T_Ch7','Alarm_Ch7','T_Ch8','Alarm_Ch8','T_Ch9','Alarm_Ch9','T_Ch10','Alarm_Ch10','T_Ch11','Alarm_Ch11','T_Ch12','Alarm_Ch12','T_Ch13','Alarm_Ch13','T_Ch14','Alarm_Ch14','T_Ch15','Alarm_Ch15','T_Ch16','Alarm_Ch16','T_Ch17','Alarm_Ch17','T_Ch19','Alarm_Ch19'] # assigns Column names
...
df.to_csv("C:\\Users\\IITM\\Desktop\\AMBEDKAR\\PHY15\\cccv1\\datalogger\\dataloggermerged1.csv") #use any path and file name here
#%%
...
with open("C:\\Users\\IITM\\Desktop\\AMBEDKAR\\PHY15\\cccv1\\first11.pkl",'rb') as f: # path to the .pkl file which has been processed from the .nda file
    data=pkl.load(f)
    #%%
...
#%%    
    ...
    print('...........3/3')
    data.to_pickle("C:\\Users\\IITM\\Desktop\\AMBEDKAR\\PHY15\\cccv1\\finaldoc_TimebaseMatched9.pkl")
    data.to_csv("C:\\Users\\IITM\\Desktop\\AMBEDKAR\\PHY15\\cccv1\\finaldoc_TimebaseMatchedtest9.csv")
