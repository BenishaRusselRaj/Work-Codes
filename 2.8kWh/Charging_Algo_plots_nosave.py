...
I_file="D:\\Benisha\\2.8kWh_Charging Algorithm\\Pack_5\\22_08_19\\Pack5Data18-08-2022\\Charging Data\\-charging_periodic_graph_data (1).xlsx"
T_file="D:\\Benisha\\2.8kWh_Charging Algorithm\\Pack_5\\22_08_19\\Pack5Data18-08-2022\\Charging Data\\-charging_temperature_graph_data- (1).xlsx"
V_file="D:\\Benisha\\2.8kWh_Charging Algorithm\\Pack_5\\22_08_19\\Pack5Data18-08-2022\\Charging Data\\-charging_voltage_graph_data (1).xlsx"
...
try:
    ...
    df_I=df_I[(df_I[y0]<=17)] # & (df_I[y0]>5)
    df_I=df_I[df_I['Battery Measured Voltage']>=48]
    ...
    plt.xlabel('DateTime',size=12,fontweight='bold')
    ...
    plt.plot(df_I['DateTime'],df_I[y0],'o-',label=y0,markersize=2)
    plt.xlabel('DateTime',size=12,fontweight='bold')
    plt.ylabel('Current(A)',size=12,fontweight='bold')
    plt.title('Pack Current',size=13,fontweight='bold')
    plt.grid(linestyle='dotted')
    plt.legend(loc='best',prop={'size':10})  
    
    plt.figure()
    plt.plot(df_I['DateTime'],df_I['Battery Measured Voltage'],label='Battery Measured Voltage',color='orange')
    plt.xlabel('DateTime',size=12,fontweight='bold')
    plt.ylabel('Voltage(V)',size=12,fontweight='bold')
    plt.title('Pack Voltage',size=13,fontweight='bold')
    plt.grid(linestyle='dotted')
    plt.legend(loc='best',prop={'size':10})
    
    plt.figure()
    plt.plot(df_I['DateTime'],df_I['Battery Demand Current'],'o-',label='Battery Demand Current',markersize=2,color='green')
    plt.xlabel('DateTime',size=12,fontweight='bold')
    plt.ylabel('Current(A)',size=12,fontweight='bold')
    plt.title('Pack Demand Current',size=13,fontweight='bold')
    plt.grid(linestyle='dotted')
    plt.legend(loc='best',prop={'size':10})    
