...
# Setting default values
    ...
    try:
        ...
        coal_powered_cost = number_format(round(coal_powered_cost_per_month * 12))
        re_cost = number_format(round(re_cost_per_month * 12))
        ...
        RoI = total_investment_converter_maintenance / annual_cost_savings
        RoI = round(RoI, 2)
        ...
        return render_template(
            ...
            coal_powered_cost = coal_powered_cost,
            re_cost = re_cost,
