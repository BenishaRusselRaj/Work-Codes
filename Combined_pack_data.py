# -*- coding: utf-8 -*-
"""
Created on Sat Nov 30 12:00:21 2019
...
"""
def combinedata(path1,path2, folder_path, Bin_no):
    import pandas as pd
    import numpy as np
...
#        pass
    ...
    data.to_csv(folder_path+'\\'+Bin_no+'_Combined_cyclesData_filtered_test.csv')
