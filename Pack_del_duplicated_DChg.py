# -*- coding: utf-8 -*-
"""
Created on Mon Dec  9 14:49:01 2019
...
def timecheck(path):
    ...
    import pandas as pd
    import numpy as np
    dff=pd.read_csv(path) # this is only the summary data  #Replace path with this format, in case you need to run this code alone;  "D:\\Benisha\\Code files\\Battery_Pack_mohali_Charging_Data_M4_Apr_timestates_sessionSummary.csv"
    dff1=pd.DataFrame()
